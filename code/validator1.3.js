...
(function($){
	...
	$.fn.validator = function(config)
	{
		...
		$.fn.validator.defaults = {
							inputTypes:{
							             textField:   {
                                                               inputName: 'firstName', // this is the name attribute of the HTML form element
                                                               rules: {
                                                                       min: 2,
                                                                       max: 20,
                                                                       lettersOnly: true,
							             ...
							             selectBox:  {
                                                               ...
                                                               message: 'Please select a value for this field'
                                                              },
							             radioBtn:   {
                                                               inputName: 'radio1',
                                                               rules: {
                                   ...
                                   formClasses:{
                                                ...
                                                errorClass: 'error',
                                                validClass: 'valid',
							             validMessage: 'field should be valid',
		...
		var theForm = $(this);
		var theFormRequired = $(this).find("."+opts.formClasses.requiredClass);
			...
			// start event handling for each of the required fields in the form
               theFormRequired.each(function(){
                   ...
                   $(this).change(function(){
                      ...
                      if ($(this).hasClass(opts.formClasses.requiredClass))
                      {
                   ...
                   $(this).keyup(function(){
                      // if this is a required field then validate it
                      if ($(this).hasClass(opts.formClasses.requiredClass) && $(this).attr("value") !== "")
                      {
                         $.fn.validator.validateField($(this),opts);
                      }
                   });
                   ...
                   if (($(this).attr("type") == "checkbox" || $(this).attr("type") == "radio") && $(this).hasClass(opts.formClasses.requiredClass))
                   {
                       $(this).click(function(){
                           $.fn.validator.validateField($(this),opts);
                       });
               ...
               theForm.submit(function(){
                   ...
                   {
                      alert("you still have "+opts.errorCount+" errors in the form");
     ...
     $.fn.validator.validateField = function(field,opts)
     {
         ...
         for (i in opts.inputTypes)
         {
              ...
              if (fieldName == opts.inputTypes[i].inputName)
              {
                 ...
                 fieldMessage = opts.inputTypes[i].message;
              }
         }
             ...
             if (fieldRules.hasOwnProperty(i))
             {
                switch(i)
                {
                    case "min":
                         ...
                         {
                            hasError = true;
                            errorMessage = "The input is less than the minimum required";
                         }
                         break;
                    case "max":
                         // check max length
                         ...
                         {
                            hasError = true;
                            errorMessage = "The input is longer than the minimum required";
                         }
                         break;
                    case "checkboxMin":
                    ...
                    case "lettersOnly":
                         ...
                         // could probably combine the logic of these twi if statements
                ...
                if (hasError === true)
                {
                   ...
                   if (!fieldMessage)
                   {
                      $("."+opts.formClasses.errorClass+"[title="+fieldName+"]").html(errorMessage);
                   }
                   else
                   {
                      $("."+opts.formClasses.errorClass+"[title="+fieldName+"]").html(fieldMessage);
                   }
                   opts.errorCount++;
                ...
                {
                   $("."+opts.formClasses.errorClass+"[title="+fieldName+"]").html('<span class="'+opts.formClasses.validClass+'">'+opts.formClasses.validMessage+'</span>');
	...
	// Check for Valid URL: - url regex is fucked
	...
	// Check for Valid Email Address: - this regex seems to be working, will need to do some proper testing on it though
